/* scavenger-opcm.h -- Header used in scavenger-opc.h
...
#ifndef SCAVENGER_OPCM
#define SCAVENGER_OPCM


enum scavenger_instr
{
	/* Begin generated code: instruction names */
sll,
sra,
jr,
addu,
...
sh,
sw,
    /* End generated code: instruction names */
  invalid_inst
};


//------------------------------------------------------
enum scavenger_instr_type
{
  arithmetic_inst,
  logical_inst,
  mult_inst,
