...
|--------+----------------------+--------+--------+-------------+-----------------------------------------+---------------+----+----+----+------+-------------+--------+-------+--------------+---|
|      0 | xxxxxtttttdddddiiiii |      0 | sll    | rd,rs,imm   | RD = RT << imm                          |               |  1 |  0 |  0 |    0 | destination | source | shift | shift        |   |
|      0 | xxxxxtttttdddddiiiii |      3 | sra    | rd,rs,imm   | RD = $signed(RT) >>> imm                |               |  1 |  0 |  0 |    0 |             |        |       | shift, 64bit |   |
